  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '200%',
        height: '200%',
        background: 'radial-gradient(circle, rgba(14, 124, 102, 0.08) 0%, transparent 70%)',
        pointerEvents: 'none'
      }} />
      ...
      >
        ...
        <div style={{
          ...
          height: '48px',
          margin: '0 auto 12px',
          background: isDragActive ? 'rgba(14, 124, 102, 0.22)' : '#d7f0ea',
          borderRadius: '50%',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
        ...
        <div>
          ...
          <Text style={{ color: '#6b7585', fontSize: '14px', lineHeight: '1.5' }}>
      ...
      {files.video && (
        <div style={{ marginBottom: '16px' }}>
          <Text strong style={{ color: '#14181f', fontSize: '14px', marginBottom: '8px', display: 'block' }}>
            项目名称
          </Text>
          <Input
            value={projectName}
                ...
                <div
                  ...
                  style={{
                    ...
                    background: isSelected 
                      ? `${category.color}18` 
                      : '#ffffff',
                    color: isSelected ? '#085445' : '#3d4654',
                    boxShadow: 'none',
                    cursor: 'pointer',
      ...
      {Object.keys(files).length > 0 && (
        <div style={{ marginBottom: '16px' }}>
          <Text strong style={{ color: '#14181f', fontSize: '14px', marginBottom: '12px', display: 'block' }}>
            已选择文件
          </Text>
            ...
            {files.video && (
              <div style={{ 
                ...
                <Space size="middle">
                  ...
                  <div>
                    <Text style={{ color: '#14181f', fontWeight: 600, display: 'block', fontSize: '14px' }}>
                      {files.video.name}
                    </Text>
                    <Text style={{ color: '#6b7585', fontSize: '13px' }}>
      ...
      {uploading && (
        <div style={{ 
          ...
          <div style={{ marginBottom: '12px' }}>
            <Text style={{ color: '#14181f', fontWeight: 600, fontSize: '14px' }}>导入进度</Text>
            <Text style={{ color: '#0e7c66', float: 'right', fontWeight: 600, fontSize: '14px' }}>
              {uploadProgress}%
            </Text>
          </div>
          <Progress 
          ...
          />
          <Text style={{ color: '#6b7585', fontSize: '13px', marginTop: '8px', display: 'block', textAlign: 'center' }}>
            正在导入文件，请稍候...
          </Text>
        </div>
      )}
        ...
        <div style={{ textAlign: 'center', marginTop: '8px' }}>
          <Button 
            ...
            style={{
              ...
              padding: '0 32px',
              borderRadius: '24px',
              background: uploading ? '#6b7585' : '#0e7c66',
              border: 'none',
              fontSize: '16px',
              fontWeight: 600,
              boxShadow: 'none',
