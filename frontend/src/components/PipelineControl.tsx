...
const PipelineControl: React.FC<PipelineControlProps> = ({ 
  ...
  const fetchPipelineStatus = async () => {
    try {
      ...
      const response = await fetch(apiUrl(`/pipeline/status/${projectId}`));
      if (!response.ok) {
  ...
  const startPipeline = async () => {
    try {
      ...
      const response = await fetch(apiUrl(`/pipeline/start/${projectId}`), {
        method: 'POST'
      });
  ...
  const stopPipeline = async () => {
    try {
      ...
      const response = await fetch(apiUrl(`/pipeline/stop/${projectId}`), {
        method: 'POST'
      });
  ...
  const restartPipeline = async () => {
    try {
      ...
      const response = await fetch(apiUrl(`/pipeline/restart/${projectId}`), {
        method: 'POST'
      });
