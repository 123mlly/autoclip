...
class APISettings(BaseModel):
    ...
    model_name: str = Field(default='qwen3.7-plus', validation_alias=AliasChoices('API_MODEL_NAME'))
...
class Settings(BaseSettings):
    ...
    api_model_name: str = Field(default='qwen3.7-plus', validation_alias=AliasChoices('API_MODEL_NAME'))
