...
class SubtitleProcessor:
    ...
    def _process_subtitle_segment(self, sub: SubRipItem) -> Dict:
        ...
        # 分解文本为单词
        words = self._split_text_to_words(sub.text, start_seconds, end_seconds, sub.index)
    ...
    def _split_text_to_words(self, text: str, start_time: float, end_time: float, sub_index: int = 0) -> List[Dict]:
        """
        将文本分解为单词，并分配时间戳
